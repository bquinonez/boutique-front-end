    ...
    return (
      <div className ="look">
        <section>
          ...
          <p className="book"> Flouresce: a glow that is emitted from a source that has absorbed light. <br></br> Be the energy you wish to attract. </p>
            <Image src={wed1} size='huge' centered />
          {/* <p className="book">
